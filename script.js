    ...
    questions.forEach((q, index) => {
        quizHTML += `
            <div class="question-block bg-white/80 p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-lg transition-shadow duration-300">
                ...
                <div class="options-container flex flex-nowrap justify-center gap-3">
        `;
        options.forEach(opt => {
            quizHTML += `
                <label class="option-label flex-1 cursor-pointer text-gray-700 hover:text-emerald-600 transition-colors duration-200 whitespace-nowrap px-4 py-3 rounded-md border border-gray-300 hover:border-emerald-500 bg-white/80 text-center">
